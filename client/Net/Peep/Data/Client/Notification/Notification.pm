package Net::Peep::Data::Client::Notification;
...
sub Name { return 'notification'; } # end sub Name

sub Attributes {

	my $self = shift;
	my %attributes = ( 
			   hosts=>1,recipients=>1,level=>1
			   );
...
Net::Peep::Data::Client::Notification - Perl extension for representing client
