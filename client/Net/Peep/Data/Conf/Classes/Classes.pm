package Net::Peep::Data::Conf::Classes;
...
sub Name { return 'classes'; } # end sub Name
...
sub Handlers {
	...
	my $self = shift;
	my %handlers = ( 'class' => 'Net::Peep::Data::Conf::Class' );
...
Net::Peep::Data::Conf::Classes - Perl extension for representing class
