package Net::Peep::Data::Conf::Class::Servers;
...
sub Name { return 'servers'; } # end sub Name
...
sub Handlers {
	...
	my $self = shift;
	my %handlers = ( 'server' => 'Net::Peep::Data::Conf::Class::Server' );
...
Net::Peep::Data::Conf::Class::Servers - Perl extension for representing class
