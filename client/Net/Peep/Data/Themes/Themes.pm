...
sub Name { return 'themes'; } # end sub Name
...
sub Handlers {
	...
	my $self = shift;
	my %handlers = ( 'theme' => 'Net::Peep::Data::Theme' );
...
Net::Peep::Data::Themes - Perl extension for representing theme configuration
information.
