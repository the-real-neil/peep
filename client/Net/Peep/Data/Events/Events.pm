...
sub Name { return 'events'; } # end sub Name
...
sub Handlers {
	...
	my $self = shift;
	my %handlers = ( 'event' => 'Net::Peep::Data::Event' );
...
Net::Peep::Data::Events - Perl extension for representing event configuration
information.
