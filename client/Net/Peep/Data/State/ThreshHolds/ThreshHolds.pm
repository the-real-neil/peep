package Net::Peep::Data::State::ThreshHolds;
...
sub Name { return 'threshholds'; } # end sub Name
...
sub Handlers {
	...
	my $self = shift;
	my %handlers = ( 'threshhold' => 'Net::Peep::Data::State::ThreshHold' );
...
Net::Peep::Data::State::ThreshHolds - Perl extension for representing state
threshhold configuration information.
