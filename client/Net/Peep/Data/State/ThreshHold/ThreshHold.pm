package Net::Peep::Data::State::ThreshHold;
...
sub Name { return 'threshhold'; } # end sub Name

sub Attributes {

	my $self = shift;
	my %attributes = ( level=>1,sound=>1,fade=>1 );
...
Net::Peep::Data::State::ThreshHold - Perl extension for representing state
